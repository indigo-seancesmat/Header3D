...
export default {
    ...
    mounted() {
        ...
        this.ticker.add(() => {
            this.img.x = (this.renderer.screen.width / 2) + this.x / (this.sensitivity * 5);
            this.img.y = (this.renderer.screen.height / 2) + this.y / (this.sensitivity * 5);
            this.depthMapCont.x = (this.renderer.screen.width / 2) + this.x / (this.sensitivity * 5);
            this.depthMapCont.y = (this.renderer.screen.height / 2) + this.y / (this.sensitivity * 5);
    ...
    methods: {
        setScale() {
            ...
            if (this.containerRatio > this.imageRatio) {
                this.scale = (this.width / this.imgTexture.width) + 0.003;
            } else {
                this.scale = (this.height / this.imgTexture.height + 0.003);
            }
